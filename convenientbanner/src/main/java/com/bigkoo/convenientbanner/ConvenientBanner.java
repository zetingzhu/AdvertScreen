...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    public ConvenientBanner setPages(CBViewHolderCreator<Holder<String>> holderCreator, List<T> datas) {
        this.mDatas = datas;
     ...
     * @return
     */
    public ConvenientBanner setListData(List<T> datas){
        this.mDatas = datas;
        pageAdapter.setData( datas );
    ...
    public ConvenientBanner startTurning(long autoTurningTime) {
        Log.v(TAG , "动画设置多少秒切换一次：" + autoTurningTime );
        ...
        public void run() {
            ...
            if (convenientBanner != null) {
                ...
                if (convenientBanner.viewPager != null && convenientBanner.turning) {
                    ...
                    Log.v(TAG , "动画定时切换 - 切换的下一个page:" + page ) ;

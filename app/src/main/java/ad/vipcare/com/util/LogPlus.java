...
public class LogPlus {
     ...
     */
    public static void init(String prefix, @LogLevel int logLevel , boolean writeFile) {
        if (prefix != null) {
            prefix = prefix.trim();
            if (prefix.length() > 0) {
                sPrefix = prefix;
    ...
    public static void sd(@Nullable String tag, String msg, @Nullable Throwable tr) {
        log(Log.INFO, tag, msg, tr , true);
    }

    public static void sd(String msg, @Nullable Throwable tr) {
        log(Log.INFO, null, msg, tr , true);
    }

    public static void sd(@Nullable String tag,String msg) {
        log(Log.INFO, tag, msg, null , true);
    }

    public static void sd(String msg) {
        log(Log.INFO, null, msg, null , true);
    }

    private static void log(int logLevel, String tag, String msg, Throwable tr) {
        log(logLevel , tag , msg , tr , false );
    }

    private static void log(int logLevel, String tag, String msg, Throwable tr , boolean writeFile) {
